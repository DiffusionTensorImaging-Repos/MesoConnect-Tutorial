...
The MesoConnect Atlas comprises group probabilistic maps of mesolimbic tracts generated from Human Connectome Project 7 T diffusion data (Vu et al., 2015) using probabilistic tractography (Tournier et al., 2010) with tract-specific exclusion masks, streamline cleaning and group-level probabilistic mapping. Maps are distributed in FSL MNI152 1 mm space (182 × 218 × 182 voxels).
...
1. *Corridor-constrained tractography.* The warped and dilated atlas defines the region within which participant-level tractography may travel. Streamlines are estimated from the participant's data. This mode supports along-tract analysis and is the subject of the workflow section.
...
Atlas space is FSL MNI152 1 mm space unless stated otherwise. Native space refers to a participant's T1, diffusion or NODDI grid. Releases in MNI 2 mm and MNI152NLin2009cAsym space are planned.
