...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    'explorer',
    {type: 'category', label: 'Other ways to use the atlas', items: ['appendix/whole-tract', 'appendix/synthetic-streamlines']},
    {type: 'category', label: 'Reference', items: ['reference/parameters', 'reference/troubleshooting', 'reference/software', 'reference/scripts', 'reference/citation']},
  ],
};
